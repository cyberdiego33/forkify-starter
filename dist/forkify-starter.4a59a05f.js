...
const controlLoadSearch = async function() {
    try {
        ...
        (0, _resultsviewJsDefault.default).render(_modelsJs.getSearchResultPage(1));
        // Render initial pagination buttons
        (0, _paginationviewJsDefault.default).render(_modelsJs.modelState.searchs);
    } catch (error) {
...
const controlPagination = function(goto) {
    ...
    (0, _resultsviewJsDefault.default).render(_modelsJs.getSearchResultPage(goto));
...
const getNewRecipe = async function(newData) {
    try {
        ...
        await _modelsJs.uploadRecipe(newData);
        ...
        console.error("\uD83E\uDD21", error);
        (0, _addrecipeviewJsDefault.default).RenderErrorMes(error);
    }
};
//////////////////////////////////////////
// Initializing the app
const init = function() {
    (0, _bookmarkedviewJsDefault.default).addBookMarksHandler(loadBookMarks);
    ...
    (0, _addrecipeviewJsDefault.default).handleSubmit(getNewRecipe);
};
init();

},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","core-js/modules/web.immediate.js":"bzsBv","regenerator-runtime/runtime":"f6ot0","./models.js":"3JKkD","./views/recipeview.js":"6kxfp","./views/searchview.js":"3up1j","./views/resultsview.js":"hncNs","./views/bookmarkedview.js":"cdxGc","./views/paginationview.js":"eayKT","./views/addrecipeview.js":"igYoR","./config.js":"2hPh4"}],"jnFvT":[function(require,module,exports,__globalThis) {
...
},{}],"3JKkD":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
const loadServings = function(newServings) {
...
const APIKEY = '8f621e6c-17a3-41d0-8f08-2f4113481e22';
...
},{"./views":"h3Eg6","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","./previewview":"fD8dS"}],"fD8dS":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _iconsSvg = require("url:../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
var _views = require("./views");
var _viewsDefault = parcelHelpers.interopDefault(_views);
const PreviewView = class extends (0, _viewsDefault.default) {
    _parentElement = '';
    _generateHTml() {
        const hashId = window.location.hash.slice(1);
        return `
        <li class="preview">
            <a class="preview__link ${hashId === this._data.id ? 'preview__link--active' : ''}" href="#${this._data.id}">
...
},{"./previewview":"fD8dS","./views":"h3Eg6","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"eayKT":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _iconsSvg = require("url:../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
var _views = require("./views");
var _viewsDefault = parcelHelpers.interopDefault(_views);
const PaginationView = class extends (0, _viewsDefault.default) {
    ...
    _generateHTml() {
        ...
        // page 1 only
        if (one && presentPage === numPages) return `page 1 only`;
        // page 1 and next
        if (one && presentPage < numPages) return `
          <button data-goto="${presentPage + 1}" class="btn--inline pagination__btn--next">
      ...
      `;
        ...
        if (!one && presentPage < numPages) return `
        <button data-goto="${presentPage - 1}" class="btn--inline pagination__btn--prev">
            <svg class="search__icon">
...
},{"url:../../img/icons.svg":"fd0vu","./views":"h3Eg6","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"igYoR":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _iconsSvg = require("url:../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
var _views = require("./views");
var _viewsDefault = parcelHelpers.interopDefault(_views);
const AddRecipeView = class extends (0, _viewsDefault.default) {
